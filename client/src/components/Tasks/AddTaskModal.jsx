        ...
        <div className="modal-overlay" onClick={onClose}>
            <section className="modal" onClick={e => e.stopPropagation()}>
                ...
                <form className="modal__form" onSubmit={handleSubmit}>
                    ...
                    <div className="modal__form-group">
                        <label className="modal__label" htmlFor="task-project">Project:</label>
                        <select
                            id="task-project"
                            className="modal__input"
                            value={project}
                    ...
                    <div className="modal__form-group">
                        ...
                        <div>
                            <label className="modal__label" htmlFor="task-labels">Labels:</label>
                            <select
                                id="task-labels"
                                className="modal__input"
                                multiple
                                value={labels}
                                onChange={e =>
                                    setLabels(Array.from(e.target.selectedOptions, option => option.value))
                                }
                            >
                                {allLabels.map(label => (
